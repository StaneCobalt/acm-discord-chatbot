...
var stayinAlive = new Discord.Client({autoReconnect:true});
client.on('ready',() => {
...
function getNextEvent(){
  ...
  if((currentDate === 12) || (currentDate > 5 && currentDate < 8)){
    ...
    if(Date.today().is().monday() === 1) currentEvent += "today at 6:30pm!";
      ...
      //eventDate.setDate(eventDate.getDate() + (1 + 7 - eventDate.getDay()) % 7);
      var stringDate = eventDate.toString("MMM-d-yyyy");
      //eventDate.setTimezone("CDT");
      currentEvent += "Monday " + stringDate + " at 6:30pm!";
    }
    return currentEvent;
  }
}
...
/*------------date.js is below, will trim out what's needed eventually--------------*/
